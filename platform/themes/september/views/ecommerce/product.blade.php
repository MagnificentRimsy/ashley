@php
    if (EcommerceHelper::isReviewEnabled()) {
        $ratingAvg = get_average_star_of_product($product->id);
        $countRating = get_count_reviewed_of_product($product->id);
    }
            ...
            <div class="product__header">
                ...
                <div class="product__info">
                    ...
                    <div>
                        <div>
                            @if ($product->sku)
                                {{ __('SKU') }}: <span id="product-sku" class="sku" itemprop="sku">{{ $product->sku }}</span>
                            @endif
